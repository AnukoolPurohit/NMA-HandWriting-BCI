from .transforms import get_cnn_transforms
from ..dataset import NeuroDataset
from torch.utils.data import DataLoader, random_split


def get_neuro_dataloaders(path, get_transforms=get_cnn_transforms,
                          test_size=0.1, batch_size=64, generator=None):
    neuro_dataset = NeuroDataset.from_path(path, get_transforms)
